...
export const EMOJI_CORE_SEQUENCE = regex
  `${EMOJI_FLAG_SEQUENCE}|${EMOJI_MODIFIER_SEQUENCE}|${EMOJI_KEYCAP_SEQUENCE}|${EMOJI_PRESENTATION_SEQUENCE}`();
...
export const EMOJI = regex
  `${EMOJI_SEQUENCE}|\p{Emoji_Presentation}|\p{Extended_Pictographic}`();
